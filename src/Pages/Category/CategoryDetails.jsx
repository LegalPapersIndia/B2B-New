...
//               <button className="bg-orange-600 hover:bg-orange-700 transition px-6 py-3 rounded-xl font-semibold">
//                 Get Best Price
//               </button>

//               <button className="bg-white text-black hover:bg-gray-200 transition px-6 py-3 rounded-xl font-semibold">
//                 Contact Suppliers
//               </button>
