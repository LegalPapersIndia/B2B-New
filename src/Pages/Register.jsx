...
//   return (
//     <section className="min-h-screen bg-gradient-to-b from-white via-orange-50 to-white flex items-center justify-center px-4 py-10 overflow-hidden">

//       <div className="max-w-6xl w-full grid lg:grid-cols-2 bg-white rounded-[40px] overflow-hidden shadow-2xl border border-gray-100">

//         {/* LEFT SIDE */}
//         <div className="relative hidden lg:flex flex-col justify-center bg-blue-900 text-white p-14 overflow-hidden">
...
//             <div className="w-20 h-20 rounded-3xl bg-orange-600 flex items-center justify-center mb-8 shadow-2xl">
...
//               className="w-full border border-gray-200 hover:border-orange-300 bg-white hover:bg-orange-50 transition-all duration-300 py-4 rounded-2xl flex items-center justify-center gap-3 font-medium shadow-sm hover:shadow-md"
//             >
...
//                   required
//                   className="w-full h-14 pl-14 pr-4 rounded-2xl border border-gray-200 focus:border-orange-500 focus:outline-none transition-all"
//                 />
//               </div>
...
//                   required
//                   className="w-full h-14 pl-14 pr-14 rounded-2xl border border-gray-200 focus:border-orange-500 focus:outline-none transition-all"
//                 />
...
//                 whileTap={{ scale: 0.98 }}
//                 type="submit"
//                 className="w-full bg-orange-600 hover:bg-blue-800 transition-all duration-300 text-white h-14 rounded-2xl font-semibold shadow-md hover:shadow-xl flex items-center justify-center gap-2"
//               >
//                 Create Account
